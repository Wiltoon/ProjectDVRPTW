...
//    }
    ...
    public static double euclidianDistance(int i, int j) {
        double xd = 0, yd = 0;
    ...
    public static int ceil_distance(int i, int j) {
    ...
    public static int geo_distance(int i, int j) {
        double deg, min;
    ...
    public static int att_distance(int i, int j) {
        double xd = instance.nodes[i].x - instance.nodes[j].x;
        double yd = instance.nodes[i].y - instance.nodes[j].y;
    ...
    /**
     * Computando as distancias "reais" de acordo com o SCORE
     * Distance_type
     * @param scalingValue SCORE escolhido de acordo com o tempo
     * @return 
     */
//    public static double[][] compute_distances(double scalingValue) {
//        int i, j;
//        int size = VRPTW.n;
...
//
//    /**
//     * Computa o numero dos vizinhos mais próximos
//     * @param vrp
//     * @return 
//     */
//    //computes nearest neighbor lists of depth nn for each city
//    public static int[][][] compute_nn_lists(VRPTW vrp) {
//        int i, node, nn, count1, count2;
//
//        int size = VRPTW.n; //VRPTW.n numero de nós a ser vizitado
//        double[] distance_vector = new double[size + 1];
//        int[] help_vector = new int[size + 1];
//
//        nn = Ants.nn_ants; //Cada "veículo" pode carregar no máximo 200 itens 
//        if (nn >= size + 1) {
//            nn = size - 2;
//        }
//        Ants.nn_ants = nn; // Quem é nn_ants ?
//
...
//            /* city itself is not nearest neighbor */
...
//    }
    ...
    public static double compute_tour_length(ArrayList<Integer> t) {
        int i;
        double sum = 0;
    ...
    //compute the tour length of tour t taking also into account the depot city
    public static double compute_tour_length1(ArrayList<Integer> t) {
        int i;
        double sum = 0;
    ...
    public static double compute_tour_length_(ArrayList<Integer> t) {
        int i;
        double sum = 0;
